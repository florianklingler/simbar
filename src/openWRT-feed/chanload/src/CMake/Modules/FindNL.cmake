...
if(NL_LIBRARIES AND NL_INCLUDE_DIRS)
  ...
  message("NL3_FOUND: ${NL3_FOUND}")
  if(NOT NL3_FOUND)
    pkg_search_module(NL2 libnl-2.0)
    message("seach for nl version2")
  endif()
  message("search for stuff")
  message("NL3_libnl-3.0_INCLUDEDIR: ${NL3_libnl-3.0_INCLUDEDIR}")
  ...
  # NL version >= 2
  message("NL3_INCLUDE_DIR: ${NL3_INCLUDE_DIR}")
  if(NL3_INCLUDE_DIR)
    ...
    #
    message("NL3_LIBRARY: ${NL3_LIBRARY}")
    message("NLROUTE_LIBRARY: ${NLROUTE_LIBRARY}")
    message("NLGENL_LIBRARY: ${NLGENL_LIBRARY}")
    if(NL3_LIBRARY AND NLGENL_LIBRARY AND NLROUTE_LIBRARY)
      set(NL_LIBRARY ${NL3_LIBRARY})
      message("NL_LIBRARY: ${NL_LIBRARY}")
      if(NL3_INCLUDE_DIR)
    ...
    message("NL_INCLUDE_DIR: ${NL_INCLUDE_DIR}")
  endif()

  message("Before searching for NL verison1")
